...
- **Ambient music** — no visible control at all; music starts automatically at 30% volume when the invitation is opened, and pauses/resumes automatically when the browser tab is hidden/shown
